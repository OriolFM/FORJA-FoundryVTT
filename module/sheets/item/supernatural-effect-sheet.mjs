...
export default class ForjaSupernaturalEffectSheet extends HandlebarsApplicationMixin(foundry.applications.sheets.ItemSheetV2) {
  ...
  static DEFAULT_OPTIONS = {
    ...
    actions: {
      addSkillBonus: ForjaSupernaturalEffectSheet._addSkillBonus,
      removeSkillBonus: ForjaSupernaturalEffectSheet._removeSkillBonus,
      addStateApplied: ForjaSupernaturalEffectSheet._addStateApplied,
      removeStateApplied: ForjaSupernaturalEffectSheet._removeStateApplied,
      addTraitGranted: ForjaSupernaturalEffectSheet._addTraitGranted,
      removeTraitGranted: ForjaSupernaturalEffectSheet._removeTraitGranted
    }
  };
