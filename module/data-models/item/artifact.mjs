/**
 * Data model for Artifact items.
 * Ported from FORJAPP src/types/character.ts (CharacterArtifact)
 */
export default class ArtifactData extends foundry.abstract.TypeDataModel {
  ...
  static defineSchema() {
    ...
    return {
      ...
      rechargeRate: new fields.NumberField({ integer: true, min: 0, initial: 0 }),
      ...
      baseWeapon: new fields.StringField({ initial: "" }),
